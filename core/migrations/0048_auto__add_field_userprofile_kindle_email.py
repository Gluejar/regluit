...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.kindle_email'
        db.add_column('core_userprofile', 'kindle_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=254, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.kindle_email'
        db.delete_column('core_userprofile', 'kindle_email')
    ...
    models = {
        ...
        'core.celerytask': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 31, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
