...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field manager on 'Campaign'
        db.create_table('core_campaign_manager', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('campaign', models.ForeignKey(orm['core.campaign'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('core_campaign_manager', ['campaign_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field manager on 'Campaign'
        db.delete_table('core_campaign_manager')
    ...
    models = {
        ...
        'core.campaign': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'manager': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'campaigns'", 'symmetrical': 'False', 'to': "orm['auth.User']"}),
        ...
        'core.celerytask': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 19, 8, 27, 9, 842289)', 'auto_now_add': 'True', 'blank': 'True'}),
