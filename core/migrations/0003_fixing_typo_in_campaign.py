...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_campaign', 'suspended_reason', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Campaign.supended_reason'
        db.add_column('core_campaign', 'supended_reason', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)
    ...
    models = {
        ...
        'core.campaign': {
            ...
            'suspended_reason': ('django.db.models.fields.TextField', [], {'null': 'True'}),
