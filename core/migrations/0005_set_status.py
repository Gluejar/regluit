...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for campaign in orm.Campaign.objects.all():
            campaign.status=self.set_status(campaign)
            campaign.save()
    ...
    def set_status(self,campaign):
        """ won't deal with campaign success
        """
        
        if campaign.activated is None:
            return 'INITIALIZED'
        elif campaign.suspended is not None:
            return 'SUSPENDED'
        elif campaign.withdrawn is not None:
            return 'WITHDRAWN'
        else:
            return 'ACTIVE'
    ...
    models = {
        ...
        'core.celerytask': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 6, 9, 8, 30, 614316)', 'auto_now_add': 'True', 'blank': 'True'}),
