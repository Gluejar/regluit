...
class Migration(DataMigration):
    ...
    models = {
        ...
        'core.celerytask': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 3, 14, 40, 40, 853094)', 'auto_now_add': 'True', 'blank': 'True'}),
