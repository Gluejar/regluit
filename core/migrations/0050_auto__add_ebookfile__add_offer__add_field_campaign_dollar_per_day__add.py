...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_ebookfile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('format', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('edition', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ebook_files', to=orm['core.Edition'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('core', ['EbookFile'])

        # Adding model 'Offer'
        db.create_table('core_offer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('work', self.gf('django.db.models.fields.related.ForeignKey')(related_name='offers', to=orm['core.Work'])),
            ('price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2)),
            ('license', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1)),
        ...
        db.add_column('core_campaign', 'cc_date_initial',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Campaign.type'
        db.add_column('core_campaign', 'type',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'RightsHolder.can_sell'
        db.add_column('core_rightsholder', 'can_sell',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('core_ebookfile')

        # Deleting model 'Offer'
        db.delete_table('core_offer')

        # Deleting field 'Campaign.dollar_per_day'
        db.delete_column('core_campaign', 'dollar_per_day')

        # Deleting field 'Campaign.cc_date_initial'
        db.delete_column('core_campaign', 'cc_date_initial')

        # Deleting field 'Campaign.type'
        db.delete_column('core_campaign', 'type')

        # Deleting field 'RightsHolder.can_sell'
        db.delete_column('core_rightsholder', 'can_sell')
