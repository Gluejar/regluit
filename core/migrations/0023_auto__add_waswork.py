...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'WasWork'
        db.create_table('core_waswork', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('work', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Work'])),
            ('was', self.gf('django.db.models.fields.IntegerField')(unique=True)),
        ))
        db.send_create_signal('core', ['WasWork'])


    def backwards(self, orm):
        
        # Deleting model 'WasWork'
        db.delete_table('core_waswork')
    ...
    models = {
        ...
        'core.celerytask': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 9, 22, 5, 52, 422706)', 'auto_now_add': 'True', 'blank': 'True'}),
