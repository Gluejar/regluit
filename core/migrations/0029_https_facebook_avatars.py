...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for user in User.objects.all():
            p = user.profile
            if p.pic_url.startswith('http://graph.facebook.com'):
                p.pic_url = p.pic_url.replace('http://graph.facebook.com', 'https://graph.facebook.com')
                p.save()
    ...
    models = {
        ...
        'core.celerytask': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 3, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
