...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Hold'
        db.create_table('core_hold', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('work', self.gf('django.db.models.fields.related.ForeignKey')(related_name='holds', to=orm['core.Work'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='holds', to=orm['auth.User'])),
            ('library', self.gf('django.db.models.fields.related.ForeignKey')(related_name='holds', to=orm['libraryauth.Library'])),
        ))
        db.send_create_signal('core', ['Hold'])

        # Adding field 'Acq.refreshed'
        db.add_column('core_acq', 'refreshed',
    ...
    def backwards(self, orm):
        # Deleting model 'Hold'
        db.delete_table('core_hold')

        # Deleting field 'Acq.refreshed'
        db.delete_column('core_acq', 'refreshed')
    ...
    models = {
        ...
        'core.acq': {
            ...
            'refreshes': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 7, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'core.celerytask': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 7, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
