...
INVISIBLE = ["Accessible book", "Protected DAISY", "OverDrive", "In library", "Large type books"]
class Migration(SchemaMigration):
    no_dry_run = True
    def forwards(self, orm):
        # Adding field 'Subject.is_visible'
        db.add_column('core_subject', 'is_visible',
    ...
    def backwards(self, orm):
        # Deleting field 'Subject.is_visible'
        db.delete_column('core_subject', 'is_visible')
    ...
    models = {
        ...
        'core.acq': {
            ...
            'refreshes': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 9, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'core.celerytask': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 9, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
