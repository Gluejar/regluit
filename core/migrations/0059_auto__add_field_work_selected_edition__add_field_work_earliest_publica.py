...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Work.selected_edition'
        db.add_column('core_work', 'selected_edition',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='selected_works', null=True, to=orm['core.Edition']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Work.selected_edition'
        db.delete_column('core_work', 'selected_edition_id')
        ...
        db.add_column('core_edition', 'public_domain',
    ...
    models = {
        ...
        'core.acq': {
            ...
            'refreshes': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 10, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'core.celerytask': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 10, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
