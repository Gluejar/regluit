...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CampaignAction'
        db.create_table('core_campaignaction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('campaign', self.gf('django.db.models.fields.related.ForeignKey')(related_name='actions', to=orm['core.Campaign'])),
        ))
        db.send_create_signal('core', ['CampaignAction'])

        # Deleting field 'Campaign.suspended_reason'
        db.delete_column('core_campaign', 'suspended_reason')
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'CampaignAction'
        db.delete_table('core_campaignaction')

        # Adding field 'Campaign.suspended_reason'
        db.add_column('core_campaign', 'suspended_reason', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Campaign.withdrawn_reason'
        db.add_column('core_campaign', 'withdrawn_reason', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'core.celerytask': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 13, 16, 0, 32, 621777)', 'auto_now_add': 'True', 'blank': 'True'}),
