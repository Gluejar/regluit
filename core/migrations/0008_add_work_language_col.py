...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Work.language'
        db.add_column('core_work', 'language', self.gf('django.db.models.fields.CharField')(max_length=2, null=True), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'Work.language'
        db.delete_column('core_work', 'language')
    ...
    models = {
        ...
        'core.celerytask': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 13, 2, 14, 47, 503163)', 'auto_now_add': 'True', 'blank': 'True'}),
