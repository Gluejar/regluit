...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MARCRecord.xml_record_via_unglueit'
        db.add_column('core_marcrecord', 'xml_record_via_unglueit',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'MARCRecord.mrc_record_via_unglueit'
        db.add_column('core_marcrecord', 'mrc_record_via_unglueit',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MARCRecord.xml_record_via_unglueit'
        db.delete_column('core_marcrecord', 'xml_record_via_unglueit')

        # Deleting field 'MARCRecord.mrc_record_via_unglueit'
        db.delete_column('core_marcrecord', 'mrc_record_via_unglueit')
    ...
    models = {
        ...
        'core.celerytask': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 23, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'core.marcrecord': {
            ...
            'mrc_record_via_unglueit': ('django.db.models.fields.URLField', [], {'max_length': '200'}),
            'xml_record': ('django.db.models.fields.URLField', [], {'max_length': '200'}),
            'xml_record_via_unglueit': ('django.db.models.fields.URLField', [], {'max_length': '200'})
        },
        'core.premium': {
