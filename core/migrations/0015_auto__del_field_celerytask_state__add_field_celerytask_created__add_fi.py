...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CeleryTask.state'
        db.delete_column('core_celerytask', 'state')

        # Adding field 'CeleryTask.created'
        db.add_column('core_celerytask', 'created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 11, 10, 12, 5, 23, 199881), auto_now_add=True, blank=True), keep_default=False)

        # Adding field 'CeleryTask.user'
        db.add_column('core_celerytask', 'user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tasks', null=True, to=orm['auth.User']), keep_default=False)

        # Adding field 'CeleryTask.description'
        db.add_column('core_celerytask', 'description', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True), keep_default=False)

        # Adding field 'CeleryTask.active'
        db.add_column('core_celerytask', 'active', self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'CeleryTask.state'
        db.add_column('core_celerytask', 'state', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)

        # Deleting field 'CeleryTask.created'
        db.delete_column('core_celerytask', 'created')

        # Deleting field 'CeleryTask.user'
        db.delete_column('core_celerytask', 'user_id')

        # Deleting field 'CeleryTask.description'
        db.delete_column('core_celerytask', 'description')

        # Deleting field 'CeleryTask.active'
        db.delete_column('core_celerytask', 'active')
    ...
    models = {
        ...
        'core.celerytask': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 10, 12, 5, 23, 199881)', 'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '2048', 'null': 'True'}),
            'function_args': ('django.db.models.fields.IntegerField', [], {}),
