...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.facebook_id'
        db.alter_column('core_userprofile', 'facebook_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.facebook_id'
        db.alter_column('core_userprofile', 'facebook_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
    ...
    models = {
        ...
        'core.acq': {
            ...
            'refreshes': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 16, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'core.celerytask': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 16, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
