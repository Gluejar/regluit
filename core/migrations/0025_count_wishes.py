...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for work in orm.Work.objects.all():
            work.num_wishes = orm.Wishes.objects.filter(work=work).count()
    	    work.save()
    ...
    models = {
        ...
        'core.celerytask': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 11, 12, 27, 34, 166971)', 'auto_now_add': 'True', 'blank': 'True'}),
