...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Work.language'
        db.alter_column('core_work', 'language', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))
    ...
    models = {
        ...
        'core.celerytask': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 13, 2, 29, 16, 154754)', 'auto_now_add': 'True', 'blank': 'True'}),
