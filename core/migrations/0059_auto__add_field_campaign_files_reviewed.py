...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.files_reviewed'
        db.add_column('core_campaign', 'files_reviewed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.files_reviewed'
        db.delete_column('core_campaign', 'files_reviewed')
    ...
    models = {
        ...
        'core.acq': {
            ...
            'refreshes': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 5, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'core.campaign': {
            ...
            'files_reviewed': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.celerytask': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 5, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
