...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Edition', fields ['googlebooks_id']
        db.create_unique('core_edition', ['googlebooks_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Edition', fields ['googlebooks_id']
        db.delete_unique('core_edition', ['googlebooks_id'])
    ...
    models = {
        ...
        'core.celerytask': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 20, 12, 55, 35, 47394)', 'auto_now_add': 'True', 'blank': 'True'}),
