...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # convert all works over to English and remove any non-english editions
        # since we are going to have mono-lingual works going forward
        for work in orm.Work.objects.all():
            work.language = "en"
            work.save()
            for edition in work.editions.all():
                if edition.language and edition.language != "en":
                    edition.delete()
    ...
    models = {
        ...
        'core.celerytask': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 13, 2, 20, 24, 600435)', 'auto_now_add': 'True', 'blank': 'True'}),
