...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.do_watermark'
        db.add_column('core_campaign', 'do_watermark',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.do_watermark'
        db.delete_column('core_campaign', 'do_watermark')
    ...
    models = {
        ...
        'core.acq': {
            ...
            'refreshes': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 18, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'core.celerytask': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 18, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
