...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Work.num_wishes'
        db.add_column('core_work', 'num_wishes', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Work.num_wishes'
        db.delete_column('core_work', 'num_wishes')
    ...
    models = {
        ...
        'core.celerytask': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 11, 12, 26, 37, 919838)', 'auto_now_add': 'True', 'blank': 'True'}),
