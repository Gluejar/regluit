...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gift.to'
        db.add_column('core_gift', 'to',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=75, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gift.to'
        db.delete_column('core_gift', 'to')
    ...
    models = {
        ...
        'core.acq': {
            ...
            'refreshes': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 19, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'core.celerytask': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 19, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'core.gift': {
            ...
            'to': ('django.db.models.fields.TextField', [], {'max_length': '75', 'blank': 'True'}),
