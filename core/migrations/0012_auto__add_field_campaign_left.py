...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Campaign.left'
        db.add_column('core_campaign', 'left', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=14, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Campaign.left'
        db.delete_column('core_campaign', 'left')
    ...
    models = {
        ...
        'core.celerytask': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 13, 22, 24, 45, 531933)', 'auto_now_add': 'True', 'blank': 'True'}),
