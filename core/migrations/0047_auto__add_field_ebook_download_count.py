...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ebook.download_count'
        db.add_column('core_ebook', 'download_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ebook.download_count'
        db.delete_column('core_ebook', 'download_count')
    ...
    models = {
        ...
        'core.celerytask': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 19, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
