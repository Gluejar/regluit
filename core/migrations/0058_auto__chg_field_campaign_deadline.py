...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Campaign.deadline'
        db.alter_column('core_campaign', 'deadline', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Campaign.deadline'
        db.alter_column('core_campaign', 'deadline', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 12, 20, 0, 0)))
    ...
    models = {
        ...
        'core.acq': {
            ...
            'refreshes': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 20, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'core.celerytask': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 20, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
