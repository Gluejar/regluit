...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Premium.created'
        db.add_column('core_premium', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 11, 19, 11, 23, 33, 732322), blank=True), keep_default=False)

        # Adding field 'UserProfile.created'
        db.add_column('core_userprofile', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 11, 19, 11, 23, 42, 429111), blank=True), keep_default=False)

        # Adding field 'Ebook.created'
        db.add_column('core_ebook', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 11, 19, 11, 23, 50, 847318), blank=True), keep_default=False)

        # Adding field 'RightsHolder.created'
        db.add_column('core_rightsholder', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 11, 19, 11, 24, 0, 699409), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Premium.created'
        db.delete_column('core_premium', 'created')

        # Deleting field 'UserProfile.created'
        db.delete_column('core_userprofile', 'created')

        # Deleting field 'Ebook.created'
        db.delete_column('core_ebook', 'created')

        # Deleting field 'RightsHolder.created'
        db.delete_column('core_rightsholder', 'created')
    ...
    models = {
        ...
        'core.celerytask': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 19, 11, 23, 18, 650983)', 'auto_now_add': 'True', 'blank': 'True'}),
