...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_campaign', 'status', self.gf('django.db.models.fields.CharField')(max_length=15, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Campaign.status'
        db.delete_column('core_campaign', 'status')
    ...
    models = {
        ...
        'core.celerytask': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 6, 9, 6, 50, 995737)', 'auto_now_add': 'True', 'blank': 'True'}),
