...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Acq'
        db.create_table('core_acq', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('expires', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('work', self.gf('django.db.models.fields.related.ForeignKey')(related_name='acqs', to=orm['core.Work'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='acqs', to=orm['auth.User'])),
            ('license', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1)),
        ))
        db.send_create_signal('core', ['Acq'])


    def backwards(self, orm):
        # Deleting model 'Acq'
        db.delete_table('core_acq')
    ...
    models = {
        ...
        'core.celerytask': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 19, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
