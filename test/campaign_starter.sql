...
CREATE TABLE `core_campaign` (
  ...
  KEY `core_campaign_e954ecc1` (`edition_id`),
  CONSTRAINT `edition_id_refs_id_23032dca9b286186` FOREIGN KEY (`edition_id`) REFERENCES `core_edition` (`id`),
...
-- Dump completed on 2012-05-03  1:23:06
