...
# Expiry (seconds) for S3 signed download URLs generated by download_ebook.
# 3600 = 1 hour — long enough for slow connections, interrupted downloads,
# and users who pause between clicking the link and actually downloading.
# Short enough to eliminate the "permanent URL bot harvesting" threat.
# See EbookFoundation/security-private#9.
EBOOK_DOWNLOAD_SIGNED_URL_EXPIRY_SECONDS = 3600
