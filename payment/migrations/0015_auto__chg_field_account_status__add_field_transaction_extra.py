...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Account.status'
        db.alter_column('payment_account', 'status', self.gf('django.db.models.fields.CharField')(max_length=11))
        # Adding field 'Transaction.extra'
        db.add_column('payment_transaction', 'extra',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Account.status'
        db.alter_column('payment_account', 'status', self.gf('django.db.models.fields.CharField')(max_length=16))
        # Deleting field 'Transaction.extra'
        db.delete_column('payment_transaction', 'extra')
