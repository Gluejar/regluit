...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Transaction.anonymous'
        db.add_column('payment_transaction', 'anonymous', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Transaction.anonymous'
        db.delete_column('payment_transaction', 'anonymous')
